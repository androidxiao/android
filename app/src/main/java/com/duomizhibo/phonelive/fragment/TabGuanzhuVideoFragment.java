...
public class TabGuanzhuVideoFragment extends AbsFragment implements RefreshLayout.OnRefreshListener {
    private int mPage;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mRootView = inflater.inflate(R.layout.tab_guanz_fragment, container, false);
        return mRootView;
    }
