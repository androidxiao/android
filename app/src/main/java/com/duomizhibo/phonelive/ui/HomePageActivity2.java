 ...
 * 他人信息
 */
public class HomePageActivity2 extends ToolBarBaseActivity implements RefreshLayout.OnRefreshListener {
    private Type mType;
    //昵称
    ...
    @InjectView(R.id.id_tv_sign_name)
            ...
            mRlLiveStatusView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (AppContext.getInstance().getLoginUid() == null || StringUtils.toInt(AppContext.getInstance().getLoginUid()) == 0) {
                        Toast.makeText(HomePageActivity2.this, "请登录..", Toast.LENGTH_SHORT).show();
                        return;
                    }
                    if (mUserHomePageBean.liveinfo.type.equals("6")){
                        UIHelper.shoPersonVideoActivity(HomePageActivity2.this,mUserHomePageBean.liveinfo);
                    }else {
                        VideoPlayerActivity.startVideoPlayerActivity(HomePageActivity2.this, mUserHomePageBean.liveinfo);
                    }
                }
            });
        } else {
                    ...
                    if ("200".equals(obj.getString("ret"))) {
                        ...
                        if (0 == data.getInt("code")) {
                            ...
                            if (mVideoList.size() != 0) {
                                ...
                                mVideoAdaper = new VideoAdapter2(HomePageActivity2.this, mVideoList);
            ...
            public void onResponse(String response, int id) {
                ...
                if (res != null) {
                    try {
                        ...
                        VideoBackActivity.startVideoBack(HomePageActivity2.this, mLiveRecordBean);
                    } catch (JSONException e) {
                        e.printStackTrace();
                    }
    ...
    private void pullTheBlack() {// black list
        PhoneLiveApi.pullTheBlack(AppContext.getInstance().getLoginUid(), uid,
                ...
                new StringCallback() {
                    ...
                    @Override
                    public void onError(Call call, Exception e, int id) {
                        AppContext.showToastAppMsg(HomePageActivity2.this, "操作失败");
                    }
        ...
        PhoneLiveApi.showFollow(getUserID(), uid, getUserToken(), new PhoneLiveApi.AttentionCallback() {
            ...
            public void callback(boolean isAttention) {
                if (isAttention) {
                    ...
                    mIvFollow.setBackgroundDrawable( ContextCompat.getDrawable(HomePageActivity2.this,R.drawable.ic_anchor_bt_follow_active));
                } else {
                    mUserHomePageBean.isattention = "0";
                    mFollowState.setText(getString(R.string.follow2));
                    mIvFollow.setBackgroundDrawable( ContextCompat.getDrawable(HomePageActivity2.this,R.drawable.ic_anchor_bt_follow));
                }
            }
        });
    }
